...
import { faHouse, faUser, faBook, faAddressBook, faBarsProgress, faBars, faHeart } from '@fortawesome/free-solid-svg-icons';
    ...
    <header>
      <nav>
        ...
        <ul className={`nav-links ${isMenuOpen ? 'open' : ''}`}>
          ...
          <li><FontAwesomeIcon icon={faHeart} className="iconNav"/><a href="#Hobbies"> Hobbies</a></li>
